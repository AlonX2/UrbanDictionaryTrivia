...
public class GameManager : MonoBehaviour
{
    ...
    public void MatchData()
    {
        ...
        Premium = Data.PlayerData.Premium;
    ...
    public void FirstWrite()
    {
        ...
        Data.PlayerData.Premium = Premium;
    ...
    const string androidBannerId = "sensitive data";
    const string appleBannerId = "sensitive data";
    ...
    private const string rewardAdUnitId = "sensitive data";
